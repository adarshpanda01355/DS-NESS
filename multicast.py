...
from config import MULTICAST_GROUP, MULTICAST_PORT, BUFFER_SIZE, MULTICAST_RELIABLE_RETRIES
...
class MulticastHandler:
    ...
    def send_reliable(self, message, retries=None, delay=0.1):
        """
        ...
        Args:
            ...
            retries: Number of times to send (default: MULTICAST_RELIABLE_RETRIES)
        ...
        import time
        if retries is None:
            retries = MULTICAST_RELIABLE_RETRIES
        success = False
