...
HEARTBEAT_TIMEOUT = float(os.environ.get("DS_HEARTBEAT_TIMEOUT", "10.0")) #changed from 6.0 to 10.0 to avoid split brian issues (i.e two nodes electing themselves as coordinators)
