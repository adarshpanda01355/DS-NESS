...
# Host address for this node (auto-detect or set via environment variable)
HOST = os.environ.get("DS_HOST", get_local_ip())
...
HEARTBEAT_TIMEOUT = float(os.environ.get("DS_HEARTBEAT_TIMEOUT", "10.0"))  # Increased to avoid split-brain issues
...
# Number of times to send reliable multicast messages (for critical announcements)
MULTICAST_RELIABLE_RETRIES = int(os.environ.get("DS_MULTICAST_RETRIES", "3"))
