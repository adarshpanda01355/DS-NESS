...
class VectorClock:
    ...
    def remove_node(self, node_id):
        ...
        Removing entries can cause buffered messages in the hold-back queue
        to become undeliverable if they depend on a removed node's clock entry.
        Keeping old entries is safe and prevents race conditions.
        """
